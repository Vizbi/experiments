...
num_of_countries_with_a_color = df_world.groupby('Color').nunique()['Country'].sort_values()
num_of_us_countries_with_a_color = df_usa.groupby('Color').nunique()['Number of Pixels'].sort_values(ascending=False)

countries_with_num_of_colors_in_flag = df_world.groupby('Country').nunique()['Color'].sort_values()
countries_with_num_of_colors_in_flag_usa = df_usa.groupby('Country').nunique()['Color'].sort_values()
...
average_number_of_colors_on_flag = df_world.groupby('Color').nunique()['Country'].sort_values().sum() / df_world[
    'Country'].nunique()

average_number_of_colors_on_flag_usa = df_usa.groupby('Color').nunique()['Country'].sort_values().sum() / df_usa[
    'Country'].nunique()
